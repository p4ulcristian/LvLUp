                    ...
                    [:div
                     [:ul.uk-nav.uk-dropdown-nav
                       ...
                       (map-indexed
                         ...
                         (sort-by :number @system-map))]]]]




             [:div.uk-button.uk-button-primary.uk-width-1-1.uk-margin-remove.uk-align-center
               {:on-click #(cond
                  ...
                  [:div.uk-offcanvas-content {:style {:user-select "none"}}
                    ...
                    [:div.uk-card.uk-card-secondary ;{:data-uk-sticky "show-on-up: true; uk-animation-slide-top;"}
                      ...
                      [:div.uk-child-width-1-3
                           [:a  {
                                 :data-uk-icon "icon: plus-circle; ratio: 1.5"
