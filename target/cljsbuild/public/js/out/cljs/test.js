...
var args47110 = [];
var len__37878__auto___47114 = arguments.length;
var i__37879__auto___47115 = (0);
while(true){
if((i__37879__auto___47115 < len__37878__auto___47114)){
args47110.push((arguments[i__37879__auto___47115]));

var G__47116 = (i__37879__auto___47115 + (1));
i__37879__auto___47115 = G__47116;
continue;
} else {
}
break;
...
var G__47113 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__47113,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__47113;
}
});
...
var len__37878__auto___47121 = arguments.length;
var i__37879__auto___47122 = (0);
while(true){
if((i__37879__auto___47122 < len__37878__auto___47121)){
args__37885__auto__.push((arguments[i__37879__auto___47122]));

var G__47123 = (i__37879__auto___47122 + (1));
i__37879__auto___47122 = G__47123;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37886__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq47118){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__47119,G__47120,seq47118__$2);
});
...
var map__47127 = m;
var map__47127__$1 = ((((!((map__47127 == null)))?((((map__47127.cljs$lang$protocol_mask$partition0$ & (64))) || (map__47127.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47127):map__47127);
var file = cljs.core.get.call(null,map__47127__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__47127__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__47127__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__47127,map__47127__$1,file,line,column){
return (function (p1__47124_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__47124_SHARP_));
});})(map__47127,map__47127__$1,file,line,column))
...
var temp__4657__auto___47131 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___47131)){
var message_47132 = temp__4657__auto___47131;
cljs.core.println.call(null,message_47132);
} else {
}
...
var G__47142 = exception.stack;
var G__47142__$1 = (((G__47142 == null))?null:clojure.string.split_lines.call(null,G__47142));
var G__47142__$2 = (((G__47142__$1 == null))?null:cljs.core.get.call(null,G__47142__$1,depth));
if((G__47142__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__47142__$2);
}
} else {
...
var vec__47143 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__47143,(0),null);
var column = cljs.core.nth.call(null,vec__47143,(1),null);
var vec__47146 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__47146,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__47146,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__47146,(2),null);
...
var m__$1 = (function (){var G__47150 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__47150) {
case "fail":
...
var G__47156 = (function (){var G__47155 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__47155);
} else {
return G__47155;
}
})();
...
return cljs.core.vary_meta.call(null,G__47158,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__47162 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__47162) {
...
var vec__47167 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__47167,(0),null);
var types = vec__47167;
...
return cljs.core.map.call(null,(function (p__47179){
var vec__47180 = p__47179;
var ns = cljs.core.nth.call(null,vec__47180,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__47180,(1),null);
return ((function (vec__47180,ns,vars__$1){
return (function (){
...
var G__47183 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__47183) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1){
return (function (){
var seq__47184 = cljs.core.seq.call(null,vars__$1);
var chunk__47185 = null;
var count__47186 = (0);
var i__47187 = (0);
while(true){
if((i__47187 < count__47186)){
var v = cljs.core._nth.call(null,chunk__47185,i__47187);
var temp__4657__auto___47189 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___47189)){
var t_47190 = temp__4657__auto___47189;
each_fixture_fn.call(null,((function (seq__47184,chunk__47185,count__47186,i__47187,t_47190,temp__4657__auto___47189,v,each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_47190)));
});})(seq__47184,chunk__47185,count__47186,i__47187,t_47190,temp__4657__auto___47189,v,each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1))
);
} else {
}

var G__47191 = seq__47184;
var G__47192 = chunk__47185;
var G__47193 = count__47186;
var G__47194 = (i__47187 + (1));
seq__47184 = G__47191;
chunk__47185 = G__47192;
count__47186 = G__47193;
i__47187 = G__47194;
continue;
} else {
...
var c__37613__auto__ = cljs.core.chunk_first.call(null,seq__47184__$1);
var G__47195 = cljs.core.chunk_rest.call(null,seq__47184__$1);
var G__47196 = c__37613__auto__;
var G__47197 = cljs.core.count.call(null,c__37613__auto__);
var G__47198 = (0);
seq__47184 = G__47195;
chunk__47185 = G__47196;
count__47186 = G__47197;
i__47187 = G__47198;
continue;
} else {
var v = cljs.core.first.call(null,seq__47184__$1);
var temp__4657__auto___47199__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___47199__$1)){
var t_47200 = temp__4657__auto___47199__$1;
each_fixture_fn.call(null,((function (seq__47184,chunk__47185,count__47186,i__47187,t_47200,temp__4657__auto___47199__$1,v,seq__47184__$1,temp__4657__auto__,each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_47200)));
});})(seq__47184,chunk__47185,count__47186,i__47187,t_47200,temp__4657__auto___47199__$1,v,seq__47184__$1,temp__4657__auto__,each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1))
);
} else {
}

var G__47201 = cljs.core.next.call(null,seq__47184__$1);
var G__47202 = null;
var G__47203 = (0);
var G__47204 = (0);
seq__47184 = G__47201;
chunk__47185 = G__47202;
count__47186 = G__47203;
i__47187 = G__47204;
continue;
}
} else {
...
});})(each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1))
);
});})(each_fixture_fn,G__47183,env,once_fixtures,each_fixtures,vec__47180,ns,vars__$1))
], null);
