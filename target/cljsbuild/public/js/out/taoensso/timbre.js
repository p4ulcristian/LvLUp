...
args48203.push((arguments[i__37878__auto___48211]));
...
var no_stacktrace_QMARK_ = cljs.core.get.call(null,map__48206__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.call(null,map__48206__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__48207 = data;
...
var level = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var hostname_ = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.call(null,map__48207__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq48214){
var G__48215 = cljs.core.first.call(null,seq48214);
var seq48214__$1 = cljs.core.next.call(null,seq48214);
return taoensso.timbre.swap_config_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__48215,seq48214__$1);
});
...
var args48219 = [];
var len__37877__auto___48222 = arguments.length;
var i__37878__auto___48223 = (0);
while(true){
if((i__37878__auto___48223 < len__37877__auto___48222)){
args48219.push((arguments[i__37878__auto___48223]));

var G__48224 = (i__37878__auto___48223 + (1));
i__37878__auto___48223 = G__48224;
continue;
} else {
}
break;
...
var vec__48237 = vargs;
var v0 = cljs.core.nth.call(null,vec__48237,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(msg_fmt_QMARK_)?(function (){var vec__48240 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__48240,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(msg_fmt_QMARK_)?taoensso.timbre.next_vargs.call(null,vargs__$1):vargs__$1);
var msg_ = (new cljs.core.Delay(((function (vargs__$1,_QMARK_msg_fmt,vargs__$2,auto_error_QMARK_,msg_fmt_QMARK_,vec__48237,v0){
return (function (){
var G__48243 = msg_type;
if(cljs.core._EQ_.call(null,null,G__48243)){
return "";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"p","p",151049309),G__48243)){
return taoensso.timbre.str_join.call(null,vargs__$2);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),G__48243)){
...
});})(vargs__$1,_QMARK_msg_fmt,vargs__$2,auto_error_QMARK_,msg_fmt_QMARK_,vec__48237,v0))
,null));
...
var _QMARK_msg_fmt = (cljs.core.truth_(msg_fmt_QMARK_)?(function (){var vec__48244 = vargs__$1;
var v0__$1 = cljs.core.nth.call(null,vec__48244,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(msg_fmt_QMARK_)?taoensso.timbre.next_vargs.call(null,vargs__$1):vargs__$1);
var msg_ = (new cljs.core.Delay(((function (_QMARK_meta,_QMARK_err__$1,_QMARK_meta__$1,vargs__$1,_QMARK_msg_fmt,vargs__$2,auto_error_QMARK_,msg_fmt_QMARK_,vec__48237,v0){
return (function (){
var G__48247 = msg_type;
if(cljs.core._EQ_.call(null,null,G__48247)){
return "";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"p","p",151049309),G__48247)){
return taoensso.timbre.str_join.call(null,vargs__$2);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),G__48247)){
return taoensso.encore.format_STAR_.call(null,((typeof _QMARK_msg_fmt === 'string')?_QMARK_msg_fmt:taoensso.truss.impl._invar_violation_BANG_.call(null,true,"taoensso.timbre",null,"(string? ?msg-fmt)",_QMARK_msg_fmt,null,null)),vargs__$2);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(msg_type)].join('')));
...
});})(_QMARK_meta,_QMARK_err__$1,_QMARK_meta__$1,vargs__$1,_QMARK_msg_fmt,vargs__$2,auto_error_QMARK_,msg_fmt_QMARK_,vec__48237,v0))
,null));
...
var args48248 = [];
var len__37877__auto___48253 = arguments.length;
var i__37878__auto___48254 = (0);
while(true){
if((i__37878__auto___48254 < len__37877__auto___48253)){
args48248.push((arguments[i__37878__auto___48254]));

var G__48255 = (i__37878__auto___48254 + (1));
i__37878__auto___48254 = G__48255;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args48248.length)].join('')));
...
var instant_48257 = taoensso.encore.now_dt.call(null);
var context_48258 = taoensso.timbre._STAR_context_STAR_;
var vargs_48259 = cljs.core.deref.call(null,vargs_);
var margs_48260 = taoensso.timbre.vargs__GT_margs.call(null,_QMARK_err,msg_type,vargs_48259);
var data_48261 = cljs.core.merge.call(null,_QMARK_base_data,margs_48260,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"hash_","hash_",-827203612),new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"vargs_","vargs_",552132148),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858)],[(new cljs.core.Delay(((function (instant_48257,context_48258,vargs_48259,margs_48260){
return (function (){
return cljs.core.hash.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891).cljs$core$IFn$_invoke$arity$1(margs_48260),cljs.core.get_in.call(null,margs_48260,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"hash","hash",-13781596)], null),new cljs.core.Keyword(null,"vargs","vargs",-966597273).cljs$core$IFn$_invoke$arity$1(margs_48260))], null));
});})(instant_48257,context_48258,vargs_48259,margs_48260))
,null)),instant_48257,config,_QMARK_file,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null).call(null,level),_QMARK_ns_str,level,(new cljs.core.Delay(((function (instant_48257,context_48258,vargs_48259,margs_48260){
return (function (){
return new cljs.core.Keyword(null,"vargs","vargs",-966597273).cljs$core$IFn$_invoke$arity$1(margs_48260);
});})(instant_48257,context_48258,vargs_48259,margs_48260))
,null)),context_48258,_QMARK_line,(new cljs.core.Delay(((function (instant_48257,context_48258,vargs_48259,margs_48260){
return (function (){
return new cljs.core.Keyword(null,"?err","?err",549653299).cljs$core$IFn$_invoke$arity$1(margs_48260);
});})(instant_48257,context_48258,vargs_48259,margs_48260))
,null))]));
var _QMARK_data_48262 = cljs.core.reduce.call(null,((function (instant_48257,context_48258,vargs_48259,margs_48260,data_48261){
...
});})(instant_48257,context_48258,vargs_48259,margs_48260,data_48261))
,data_48261,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__4657__auto___48263 = _QMARK_data_48262;
if(cljs.core.truth_(temp__4657__auto___48263)){
var data_48264__$1 = temp__4657__auto___48263;
var output_fn1_48265 = taoensso.encore.memoize_.call(null,cljs.core.get.call(null,config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
cljs.core.reduce_kv.call(null,((function (output_fn1_48265,data_48264__$1,temp__4657__auto___48263,instant_48257,context_48258,vargs_48259,margs_48260,data_48261,_QMARK_data_48262){
...
return cljs.core.not.call(null,rl_fn.call(null,cljs.core.force.call(null,new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_48264__$1))));
}
})();
if(rate_limit_okay_QMARK_){
var map__48251 = appender;
...
var apfn = cljs.core.get.call(null,map__48251__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.call(null,map__48251__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_48265;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay(((function (map__48251,map__48251__$1,apfn,async_QMARK_,output_fn,rate_limit_specs,rate_limit_okay_QMARK_,output_fn1_48265,data_48264__$1,temp__4657__auto___48263,instant_48257,context_48258,vargs_48259,margs_48260,data_48261,_QMARK_data_48262){
return (function (){
return output_fn.call(null,data_48264__$1);
});})(map__48251,map__48251__$1,apfn,async_QMARK_,output_fn,rate_limit_specs,rate_limit_okay_QMARK_,output_fn1_48265,data_48264__$1,temp__4657__auto___48263,instant_48257,context_48258,vargs_48259,margs_48260,data_48261,_QMARK_data_48262))
,null));
var data__$2 = cljs.core.conj.call(null,data_48264__$1,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
});})(output_fn1_48265,data_48264__$1,temp__4657__auto___48263,instant_48257,context_48258,vargs_48259,margs_48260,data_48261,_QMARK_data_48262))
...
var args48266 = [];
var len__37877__auto___48269 = arguments.length;
var i__37878__auto___48270 = (0);
while(true){
if((i__37878__auto___48270 < len__37877__auto___48269)){
args48266.push((arguments[i__37878__auto___48270]));

var G__48271 = (i__37878__auto___48270 + (1));
i__37878__auto___48270 = G__48271;
continue;
} else {
}
break;
...
args__37884__auto__.push((arguments[i__37878__auto___48275]));
...
taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq48273){
return taoensso.timbre.str_println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48273));
});
