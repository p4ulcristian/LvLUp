...
return [cljs.core.str((function (){var pred__39411 = cljs.core.instance_QMARK_;
var expr__39412 = reactive_val;
if(cljs.core.truth_(pred__39411.call(null,reagent.ratom.RAtom,expr__39412))){
return "ra";
} else {
if(cljs.core.truth_(pred__39411.call(null,reagent.ratom.RCursor,expr__39412))){
return "rc";
} else {
if(cljs.core.truth_(pred__39411.call(null,reagent.ratom.Reaction,expr__39412))){
return "rx";
} else {
if(cljs.core.truth_(pred__39411.call(null,reagent.ratom.Track,expr__39412))){
return "tr";
} else {
return "other";
}
