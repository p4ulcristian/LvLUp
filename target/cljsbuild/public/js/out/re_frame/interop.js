...
return [cljs.core.str((function (){var pred__38600 = cljs.core.instance_QMARK_;
var expr__38601 = reactive_val;
if(cljs.core.truth_(pred__38600.call(null,reagent.ratom.RAtom,expr__38601))){
return "ra";
} else {
if(cljs.core.truth_(pred__38600.call(null,reagent.ratom.RCursor,expr__38601))){
return "rc";
} else {
if(cljs.core.truth_(pred__38600.call(null,reagent.ratom.Reaction,expr__38601))){
return "rx";
} else {
if(cljs.core.truth_(pred__38600.call(null,reagent.ratom.Track,expr__38601))){
return "tr";
} else {
return "other";
}
