...
return [cljs.core.str((function (){var pred__38627 = cljs.core.instance_QMARK_;
var expr__38628 = reactive_val;
if(cljs.core.truth_(pred__38627.call(null,reagent.ratom.RAtom,expr__38628))){
return "ra";
} else {
if(cljs.core.truth_(pred__38627.call(null,reagent.ratom.RCursor,expr__38628))){
return "rc";
} else {
if(cljs.core.truth_(pred__38627.call(null,reagent.ratom.Reaction,expr__38628))){
return "rx";
} else {
if(cljs.core.truth_(pred__38627.call(null,reagent.ratom.Track,expr__38628))){
return "tr";
} else {
return "other";
}
