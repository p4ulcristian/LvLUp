...
var vec__39892_39895 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39896 = cljs.core.nth.call(null,vec__39892_39895,(0),null);
var only_after_39897 = cljs.core.nth.call(null,vec__39892_39895,(1),null);
var db_changed_QMARK__39898 = (cljs.core.some_QMARK_.call(null,only_before_39896)) || (cljs.core.some_QMARK_.call(null,only_after_39897));
if(db_changed_QMARK__39898){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39896);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39897);
...
var map__39905 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__39905__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39905__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39913 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__39913__$1 = ((((!((map__39913 == null)))?((((map__39913.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39913.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39913):map__39913);
var coeffects = map__39913__$1;
var event = cljs.core.get.call(null,map__39913__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37833__auto___39916 = arguments.length;
var i__37834__auto___39917 = (0);
while(true){
if((i__37834__auto___39917 < len__37833__auto___39916)){
args__37840__auto__.push((arguments[i__37834__auto___39917]));

var G__39918 = (i__37834__auto___39917 + (1));
i__37834__auto___39917 = G__39918;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37841__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39915){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39915));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36758__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37840__auto__ = [];
var len__37833__auto___39924 = arguments.length;
var i__37834__auto___39925 = (0);
while(true){
if((i__37834__auto___39925 < len__37833__auto___39924)){
args__37840__auto__.push((arguments[i__37834__auto___39925]));

var G__39926 = (i__37834__auto___39925 + (1));
i__37834__auto___39925 = G__39926;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37841__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39919_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39920_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39920_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39921){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39922,G__39923,seq39921__$2);
});
