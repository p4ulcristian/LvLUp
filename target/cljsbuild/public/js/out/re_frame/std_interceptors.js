...
var vec__39905_39908 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39909 = cljs.core.nth.call(null,vec__39905_39908,(0),null);
var only_after_39910 = cljs.core.nth.call(null,vec__39905_39908,(1),null);
var db_changed_QMARK__39911 = (cljs.core.some_QMARK_.call(null,only_before_39909)) || (cljs.core.some_QMARK_.call(null,only_after_39910));
if(db_changed_QMARK__39911){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39909);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39910);
...
var map__39918 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__39918__$1 = ((((!((map__39918 == null)))?((((map__39918.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39918.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39918):map__39918);
var db = cljs.core.get.call(null,map__39918__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39918__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39926 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39926__$1;
var event = cljs.core.get.call(null,map__39926__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37847__auto___39929 = arguments.length;
var i__37848__auto___39930 = (0);
while(true){
if((i__37848__auto___39930 < len__37847__auto___39929)){
args__37854__auto__.push((arguments[i__37848__auto___39930]));

var G__39931 = (i__37848__auto___39930 + (1));
i__37848__auto___39930 = G__39931;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37855__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39928){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39928));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36772__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37854__auto__ = [];
var len__37847__auto___39937 = arguments.length;
var i__37848__auto___39938 = (0);
while(true){
if((i__37848__auto___39938 < len__37847__auto___39937)){
args__37854__auto__.push((arguments[i__37848__auto___39938]));

var G__39939 = (i__37848__auto___39938 + (1));
i__37848__auto___39938 = G__39939;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37855__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39932_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39933_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39933_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39934){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39935,G__39936,seq39934__$2);
});
