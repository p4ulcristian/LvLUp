...
var vec__39094_39097 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39098 = cljs.core.nth.call(null,vec__39094_39097,(0),null);
var only_after_39099 = cljs.core.nth.call(null,vec__39094_39097,(1),null);
var db_changed_QMARK__39100 = (cljs.core.some_QMARK_.call(null,only_before_39098)) || (cljs.core.some_QMARK_.call(null,only_after_39099));
if(db_changed_QMARK__39100){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39098);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39099);
...
var map__39107 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__39107__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39107__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39115 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39115__$1;
var event = cljs.core.get.call(null,map__39115__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37851__auto___39118 = arguments.length;
var i__37852__auto___39119 = (0);
while(true){
if((i__37852__auto___39119 < len__37851__auto___39118)){
args__37858__auto__.push((arguments[i__37852__auto___39119]));

var G__39120 = (i__37852__auto___39119 + (1));
i__37852__auto___39119 = G__39120;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37859__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39117){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39117));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36776__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37858__auto__ = [];
var len__37851__auto___39126 = arguments.length;
var i__37852__auto___39127 = (0);
while(true){
if((i__37852__auto___39127 < len__37851__auto___39126)){
args__37858__auto__.push((arguments[i__37852__auto___39127]));

var G__39128 = (i__37852__auto___39127 + (1));
i__37852__auto___39127 = G__39128;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37859__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39121_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39122_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39122_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39123){
var G__39124 = cljs.core.first.call(null,seq39123);
var seq39123__$1 = cljs.core.next.call(null,seq39123);
var G__39125 = cljs.core.first.call(null,seq39123__$1);
var seq39123__$2 = cljs.core.next.call(null,seq39123__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39124,G__39125,seq39123__$2);
});
