...
var vec__39120_39123 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_39124 = cljs.core.nth.call(null,vec__39120_39123,(0),null);
var only_after_39125 = cljs.core.nth.call(null,vec__39120_39123,(1),null);
var db_changed_QMARK__39126 = (cljs.core.some_QMARK_.call(null,only_before_39124)) || (cljs.core.some_QMARK_.call(null,only_after_39125));
if(db_changed_QMARK__39126){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_39124);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_39125);
...
var map__39133 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__39133__$1 = ((((!((map__39133 == null)))?((((map__39133.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39133.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39133):map__39133);
var db = cljs.core.get.call(null,map__39133__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__39133__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__39141 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__39141__$1;
var event = cljs.core.get.call(null,map__39141__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__37877__auto___39144 = arguments.length;
var i__37878__auto___39145 = (0);
while(true){
if((i__37878__auto___39145 < len__37877__auto___39144)){
args__37884__auto__.push((arguments[i__37878__auto___39145]));

var G__39146 = (i__37878__auto___39145 + (1));
i__37878__auto___39145 = G__39146;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__37885__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq39143){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39143));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__36802__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__37884__auto__ = [];
var len__37877__auto___39152 = arguments.length;
var i__37878__auto___39153 = (0);
while(true){
if((i__37878__auto___39153 < len__37877__auto___39152)){
args__37884__auto__.push((arguments[i__37878__auto___39153]));

var G__39154 = (i__37878__auto___39153 + (1));
i__37878__auto___39153 = G__39154;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__37885__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__39147_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__39148_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__39148_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq39149){
var G__39150 = cljs.core.first.call(null,seq39149);
var seq39149__$1 = cljs.core.next.call(null,seq39149);
var G__39151 = cljs.core.first.call(null,seq39149__$1);
var seq39149__$2 = cljs.core.next.call(null,seq39149__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__39150,G__39151,seq39149__$2);
});
