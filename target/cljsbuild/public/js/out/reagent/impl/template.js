...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__37382__auto__,writer__37383__auto__,opt__37384__auto__){
return cljs.core._write.call(null,writer__37383__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__38411 = o;
(G__38411[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38412__delegate = function (args){
...
while (G__38413__i < G__38413__a.length) {G__38413__a[G__38413__i] = arguments[G__38413__i + 0]; ++G__38413__i;}
  args = new cljs.core.IndexedSeq(G__38413__a,0);
} 
return G__38412__delegate.call(this,args);};
G__38412.cljs$lang$maxFixedArity = 0;
G__38412.cljs$lang$applyTo = (function (arglist__38414){
var args = cljs.core.seq(arglist__38414);
return G__38412__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__36764__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__36764__auto__){
var and__36764__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__38419 = jsprops;
(G__38419["defaultValue"] = value);

(G__38419["onChange"] = ((function (G__38419,v,value,on_change){
return (function (p1__38417_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38417_SHARP_);
});})(G__38419,v,value,on_change))
);
...
var vec__38426 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38426,(0),null);
var id = cljs.core.nth.call(null,vec__38426,(1),null);
var class$ = cljs.core.nth.call(null,vec__38426,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38431 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38431 == null)){
} else {
var key_38432 = temp__4661__auto___38431;
(jsprops["key"] = key_38432);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38434 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38434["name"] = c);
...
var len__37851__auto___38440 = arguments.length;
var i__37852__auto___38441 = (0);
while(true){
if((i__37852__auto___38441 < len__37851__auto___38440)){
args__37858__auto__.push((arguments[i__37852__auto___38441]));

var G__38442 = (i__37852__auto___38441 + (1));
i__37852__auto___38441 = G__38442;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__37859__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38438){
var G__38439 = cljs.core.first.call(null,seq38438);
var seq38438__$1 = cljs.core.next.call(null,seq38438);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38439,seq38438__$1);
});
...
break;
default:
var G__38446 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38446;
continue;
...
var n__37691__auto___38449 = a.length;
var i_38450 = (0);
while(true){
if((i_38450 < n__37691__auto___38449)){
(a[i_38450] = reagent.impl.template.as_element.call(null,(a[i_38450])));

var G__38451 = (i_38450 + (1));
i_38450 = G__38451;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__37691__auto___38452 = a.length;
var i_38453 = (0);
while(true){
if((i_38453 < n__37691__auto___38452)){
var val_38454 = (a[i_38453]);
if((cljs.core.vector_QMARK_.call(null,val_38454)) && ((reagent.impl.template.key_from_vec.call(null,val_38454) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38453] = reagent.impl.template.as_element.call(null,val_38454));

var G__38455 = (i_38453 + (1));
i_38453 = G__38455;
continue;
} else {
}
...
var ctx = ({});
var vec__38459 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38459,(0),null);
var derefed = cljs.core.nth.call(null,vec__38459,(1),null);
...
var G__38463 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38463) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38463){
