...
return cljs.core.assoc.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"type","type",1174270348),"table",new cljs.core.Keyword(null,"number","number",1570378438),p1__49665_SHARP_,new cljs.core.Keyword(null,"reservation-type","reservation-type",-936885670),"tavern");
});})(numbers))
,numbers));
});
...
return cljs.core.map.call(null,(function (p1__49666_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__49666_SHARP_,new cljs.core.Keyword(null,"players","players",-1361554569),new cljs.core.Keyword(null,"name","name",1843675177)),new cljs.core.Keyword(null,"reservation-type","reservation-type",-936885670),"dungeon");
}),systems);
});
lvlup.crusader.reservation.reservation_systems = (function lvlup$crusader$reservation$reservation_systems(system_map){
return cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"number","number",1570378438),(function (){var G__49668 = cljs.core.deref.call(null,lvlup.crusader.reservation.reservation_type);
switch (G__49668) {
case "tavern":
...
break;
case "dungeon":
return cljs.core.map.call(null,((function (G__49668){
return (function (a){
...
return (function (p1__49671_SHARP_,p2__49670_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.quarters,p2__49670_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p2__49670_SHARP_], null));
});})(minutes))
,minutes)], null)], null);
});
;})(minutes))
...
return (function (p1__49676_SHARP_,p2__49675_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.hours_time,p2__49675_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p2__49675_SHARP_], null));
});})(date,hours))
,cljs.core.filter.call(null,((function (date,hours){
return (function (p1__49677_SHARP_){
return ((p1__49677_SHARP_ >= (12))) && ((p1__49677_SHARP_ <= (25)));
});})(date,hours))
...
return (function (p1__49678_SHARP_,p2__49679_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.one_reservation,p2__49679_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p1__49678_SHARP_], null));
});})(reservations))
...
,new cljs.core.Keyword(null,"places","places",1043491706).cljs$core$IFn$_invoke$arity$1(p1__49680_SHARP_));
});})(reservations))
...
if(cljs.core.truth_(cljs.core.some.call(null,(function (p1__49684_SHARP_){
return cljs.core._EQ_.call(null,item,p1__49684_SHARP_);
}),array))){
return cljs.core.vec.call(null,cljs.core.remove.call(null,(function (p1__49685_SHARP_){
return cljs.core._EQ_.call(null,item,p1__49685_SHARP_);
}),array));
} else {
...
return cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.map.call(null,(function (p1__49686_SHARP_){
return lvlup.crusader.reservation.get_column_reservations.call(null,p1__49686_SHARP_,item,id_name);
...
return cljs.core.some.call(null,(function (p1__49687_SHARP_){
return (((this_start >= cljs.core.first.call(null,p1__49687_SHARP_))) && ((this_finish <= cljs.core.second.call(null,p1__49687_SHARP_)))) || (((this_finish > cljs.core.first.call(null,p1__49687_SHARP_))) && ((this_finish < cljs.core.second.call(null,p1__49687_SHARP_)))) || (((this_start > cljs.core.first.call(null,p1__49687_SHARP_))) && ((this_start < cljs.core.second.call(null,p1__49687_SHARP_)))) || (((this_start <= cljs.core.first.call(null,p1__49687_SHARP_))) && ((this_finish >= cljs.core.second.call(null,p1__49687_SHARP_))));
}),ranges);
});
...
return cljs.core._EQ_.call(null,item,p1__49688_SHARP_);
});})(reservation_details))
...
return (function lvlup$crusader$reservation$choose_systems_$_iter__49696(s__49697){
return (new cljs.core.LazySeq(null,((function (system_map,reservations){
return (function (){
var s__49697__$1 = s__49697;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__49697__$1);
if(temp__4657__auto__){
var s__49697__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__49697__$2)){
var c__37554__auto__ = cljs.core.chunk_first.call(null,s__49697__$2);
var size__37555__auto__ = cljs.core.count.call(null,c__37554__auto__);
var b__49699 = cljs.core.chunk_buffer.call(null,size__37555__auto__);
if((function (){var i__49698 = (0);
while(true){
if((i__49698 < size__37555__auto__)){
var item = cljs.core._nth.call(null,c__37554__auto__,i__49698);
cljs.core.chunk_append.call(null,b__49699,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.one_system,item,details__$1,reservations], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str(new cljs.core.Keyword(null,"reservation-type","reservation-type",-936885670).cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str(new cljs.core.Keyword(null,"number","number",1570378438).cljs$core$IFn$_invoke$arity$1(item))].join('')], null)));
...
lvlup.crusader.reservation.display_time = (function lvlup$crusader$reservation$display_time(p__49701){
var vec__49705 = p__49701;
var from = cljs.core.nth.call(null,vec__49705,(0),null);
var to = cljs.core.nth.call(null,vec__49705,(1),null);
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-reservation-modal","set-reservation-modal",-1194693674),new cljs.core.Keyword(null,"id","id",-1388402092),p1__49708_SHARP_.target.value], null));
});})(date,flatpickr,reservation_details,reservations,slider_values))
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-reservation-modal","set-reservation-modal",-1194693674),new cljs.core.Keyword(null,"name","name",1843675177),p1__49709_SHARP_.target.value], null));
});})(date,flatpickr,reservation_details,reservations,slider_values))
...
return (function lvlup$crusader$reservation$reservation_$_iter__49714(s__49715){
return (new cljs.core.LazySeq(null,((function (date,system_map){
return (function (){
var s__49715__$1 = s__49715;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__49715__$1);
if(temp__4657__auto__){
var s__49715__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__49715__$2)){
var c__37554__auto__ = cljs.core.chunk_first.call(null,s__49715__$2);
var size__37555__auto__ = cljs.core.count.call(null,c__37554__auto__);
var b__49717 = cljs.core.chunk_buffer.call(null,size__37555__auto__);
if((function (){var i__49716 = (0);
while(true){
if((i__49716 < size__37555__auto__)){
var item = cljs.core._nth.call(null,c__37554__auto__,i__49716);
cljs.core.chunk_append.call(null,b__49717,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.reservation_column,item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str("h"),cljs.core.str(item)].join('')], null)));

var G__49718 = (i__49716 + (1));
i__49716 = G__49718;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49717),lvlup$crusader$reservation$reservation_$_iter__49714.call(null,cljs.core.chunk_rest.call(null,s__49715__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49717),null);
}
} else {
var item = cljs.core.first.call(null,s__49715__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lvlup.crusader.reservation.reservation_column,item], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str("h"),cljs.core.str(item)].join('')], null)),lvlup$crusader$reservation$reservation_$_iter__49714.call(null,cljs.core.rest.call(null,s__49715__$2)));
}
} else {
return null;
}
